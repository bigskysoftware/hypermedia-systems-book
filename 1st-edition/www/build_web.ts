...
const compile = (path: string) => {
  return {
    ...
    url: PREFIX + path.replace(/\.typ$/, "/").replace(/ch\d\d-|-\d-/, "/"),
...
const HypermediaSystems = new Book("Hypermedia Systems").with(
  {
    ...
    <script type="module" src="${PREFIX}/color-customizer.js"></script>
    `,
    htmlFooter: `
    <footer class="book-footer">
      <a href="${PREFIX}/" class="footer-book-title">Hypermedia Systems</a>
      <a href="${PREFIX}/book/contents/">Contents</a>
